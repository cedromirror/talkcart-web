...
export const useUnfollowUser = () => {
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      const response = await api.users.unfollow(userId);
      return response.data;
    },
    onSuccess: (data, userId) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.users.byId(userId) });
...
export const useUserPosts = (username: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.posts.getUserPosts(username);
      return response.data;
    },
    enabled: !!username,
  });
...
export const useUnlikePost = () => {
  ...
  return useMutation({
    mutationFn: async (postId: string) => {
      const response = await api.posts.unlike(postId);
      return response.data;
    },
    onSuccess: (data, postId) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.posts.byId(postId) });
...
export const useComments = (postId: string, params?: any) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.comments.getByPostId(postId, params);
      return response.data;
    },
    enabled: !!postId,
  });
...
export const useCreateComment = () => {
  ...
  return useMutation({
    mutationFn: async ({ postId, content, parentId }: { postId: string; content: string; parentId?: string }) => {
      const response = await api.comments.create(postId, { content, parentId });
      return response.data;
    },
    onSuccess: (data, { postId }) => {
...
export const useUploadMedia = () => {
  return useMutation({
    mutationFn: async ({ file, type }: { file: File; type: 'avatar' | 'cover' | 'post' }) => {
      const response = await api.media.upload(file, type);
      return response.data;
    },
    onError: (error: any) => {
...
export const useUploadMultipleMedia = () => {
  return useMutation({
    mutationFn: async ({ files, type }: { files: File[]; type: 'post' }) => {
      const response = await api.media.uploadMultiple(files, type);
      return response.data;
    },
    onError: (error: any) => {
      toast.error(error.message || 'Failed to upload media');
...
export const useProduct = (id: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.marketplace.getProductById(id);
      return response.data;
    },
    enabled: !!id,
  });
...
export const useStreams = (params?: any) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.streams.getAll(params);
      return response.data;
    },
  });
};
...
export const useLiveStreams = (params?: any) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.streams.getLive(params);
      return response.data;
    },
  });
};
...
export const useStream = (id: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await api.streams.getById(id);
      return response.data;
    },
    enabled: !!id,
  });
