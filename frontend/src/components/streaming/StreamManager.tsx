...
const StreamManager: React.FC<StreamManagerProps> = ({
  ...
  const { data: streamData } = useQuery({
    ...
    queryFn: () => api.streams.getStreamSettings(streamId),
    enabled: !!streamId,
  });

  const startStreamMutation = useMutation({
    mutationFn: (settings: StreamSettings) => api.streams.startStream(streamId, {}),
    onSuccess: () => {
  ...
  const endStreamMutation = useMutation({
    mutationFn: () => api.streams.endStream(streamId),
    onSuccess: () => {
  ...
  const updateSettingsMutation = useMutation({
    mutationFn: (settings: StreamSettings) => api.streams.updateStreamSettings(streamId, settings),
    onSuccess: () => {
