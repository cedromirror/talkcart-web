...
const MarketplaceDashboard: React.FC = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      const response: any = await api.payments.getPaymentHistory();
    ...
    <Layout>
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Paper elevation={0} sx={{ borderRadius: 2, overflow: 'hidden', mb: 4 }}>
          ...
          >
            <Tab icon={<ShoppingCart size={18} />} iconPosition="start" label="My Orders" />
            <Tab icon={<Heart size={18} />} iconPosition="start" label="Wishlist" />
            <Tab icon={<CreditCard size={18} />} iconPosition="start" label="Payment History" />
          </Tabs>
